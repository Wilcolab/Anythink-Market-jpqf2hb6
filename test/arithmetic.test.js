...
describe('Power', function () {
    ...
    it('raises a number to the power of an exponent', function (done) {
        request.get('/arithmetic?operation=power&operand1=2&operand2=1e2')
            .expect(200)
            .end(function (err, res) {
                expect(res.body).to.eql({ result: 1.2676506002282294e+30 });
                done();
            });
    });
});
